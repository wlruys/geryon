...
uv run geryon run-local \
  --run ./geryon/examples/usage/01_basics_and_sweeps/outputs/runs/01_basics_and_sweeps_demo \
  --profiles-file ./geryon/examples/configs/profiles.yaml \
  --profile local_dev
```
...
```bash
uv run geryon queue --run ./geryon/examples/usage/01_basics_and_sweeps/outputs/runs/01_basics_and_sweeps_demo
uv run geryon queue-refresh --run ./geryon/examples/usage/01_basics_and_sweeps/outputs/runs/01_basics_and_sweeps_demo
```
